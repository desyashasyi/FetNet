...
new class extends Component
{
    ...
    {
        if ($this->numberOfDays > 1) { $this->numberOfDays--; $this->updateConfig('number_of_days', $this->numberOfDays); }
    }
    public function daysIncrement(): void
    {
        if ($this->numberOfDays < 7) { $this->numberOfDays++; $this->updateConfig('number_of_days', $this->numberOfDays); }
    }
    public function hoursDecrement(): void
    {
        if ($this->numberOfHours > 1) { $this->numberOfHours--; $this->updateConfig('number_of_hours', $this->numberOfHours); }
    }
    public function hoursIncrement(): void
    {
        if ($this->numberOfHours < 16) { $this->numberOfHours++; $this->updateConfig('number_of_hours', $this->numberOfHours); }
    }
    public function slotDurationDecrement(): void
    {
        if ($this->slotDuration > 10) { $this->slotDuration -= 5; $this->updateConfig('slot_duration', $this->slotDuration); }
    }
    public function slotDurationIncrement(): void
    {
        if ($this->slotDuration < 120) { $this->slotDuration += 5; $this->updateConfig('slot_duration', $this->slotDuration); }
    }
    ...
    public function with(): array
    {
        ...
        return compact('timeSlots', 'dayLabels');
    }
}; ?>
