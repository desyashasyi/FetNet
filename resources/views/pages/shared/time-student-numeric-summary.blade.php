            ...
            <table class="table table-zebra table-sm w-full">
                <thead>
                    <tr class="border-b border-base-200">
                        ...
                        @endif
                        <th class="text-left py-2 font-medium text-base-content/60 {{ $showProgramCol ? 'w-4/12' : 'w-6/12' }}">Group</th>
                ...
                <tbody>
                    @foreach($rows as $row)
                        <tr wire:key="snumrow-{{ $row['id'] }}" class="border-b border-base-100 hover:bg-base-300/40">
                            @if($showProgramCol)
