...
class WorkloadPageRenderTest extends TestCase
{
    use RefreshDatabase;

    public function test_workload_page_renders_for_authenticated_client(): void
    {
        ...
        $program = Program::create(['client_id' => $client->id, 'abbrev' => 'CS', 'name' => 'CS Program']);
        ...
        $response = $this->actingAs($user)->get('/client/data/workload');
